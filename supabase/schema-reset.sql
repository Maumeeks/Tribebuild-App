-- ============================================================
-- TRIBEBUILD - SCHEMA DO BANCO DE DADOS (RESET COMPLETO)
-- Execute este SQL no Supabase SQL Editor
-- ============================================================

-- ============================================================
-- PARTE 1: REMOVER TABELAS EXISTENTES (ordem correta)
-- ============================================================
...
DROP TABLE IF EXISTS public.client_progress CASCADE;
...
CREATE POLICY "Users can view own webhook_logs" ON public.webhook_logs
  FOR SELECT USING (integration_id IN (SELECT id FROM public.integrations WHERE user_id = auth.uid()));
...
-- ============================================================
-- PARTE 7: CRIAR FUNÇÕES E TRIGGERS
-- ============================================================
