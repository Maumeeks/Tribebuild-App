    ...
    <footer className="bg-slate-50 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 py-12 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center justify-center gap-8">
          ...
          {/* 2. Links de Navegação (Legal & Suporte) */}
          <nav className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4">
            <Link 
              to="/" 
              onClick={scrollToTop}
              className="text-sm font-medium text-slate-600 hover:text-brand-blue dark:text-slate-400 dark:hover:text-brand-blue transition-colors"
            >
              Termos de Uso
            </Link>
            <Link 
