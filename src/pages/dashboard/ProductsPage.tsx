...
const ProductsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8 font-sans pb-20 animate-fade-in">
            ...
            <div className="p-5 flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center border border-slate-200 dark:border-slate-700">
                {product.thumbnail_url ? (
                  <img src={product.thumbnail_url} alt={product.name} className="w-full h-full object-cover rounded-xl" />
                ) : (
              ...
              {/* ✅ AÇÕES SEMPRE VISÍVEIS (Correção do Touch) */}
      ...
      {/* Modais omitidos para brevidade - Mantenha os seus modais originais aqui */}
    </div>
  );
};
