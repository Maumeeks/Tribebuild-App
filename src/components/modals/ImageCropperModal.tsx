    ...
    return (
        <div className="fixed inset-0 z-[9999] bg-black/90 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-200">
            ...
            <div className="bg-slate-950 border border-slate-800 w-full max-w-lg rounded-3xl shadow-2xl flex flex-col overflow-hidden max-h-[90vh] animate-in zoom-in-95 duration-200">
                ...
                <div className="flex-1 bg-black/50 relative flex items-center justify-center p-2 sm:p-4 min-h-0 overflow-hidden select-none">
                    ...
                    <ReactCrop
                        ...
                        aspect={1}
                        className="w-full h-full max-w-full max-h-full shadow-2xl rounded-sm ring-1 ring-white/10 flex items-center justify-center"
                    ...
                    >
                        <img
                            ...
                            alt="Edit"
                            onLoad={onImageLoad}
                            className="max-h-full max-w-full w-auto h-auto object-contain block mx-auto my-auto"
                            style={{ maxHeight: '100%', maxWidth: '100%', height: 'auto', width: 'auto' }}
                        />
                    </ReactCrop>

                    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-black/70 backdrop-blur text-white/70 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest border border-white/10 flex items-center gap-2 pointer-events-none z-20">
