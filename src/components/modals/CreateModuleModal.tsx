    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const { error } = await supabase.from('modules').insert([{
                ...
                name: name,
                order_index: 0 // Você pode implementar lógica de ordem depois
            }]);
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white dark:bg-slate-900 rounded-xl shadow-2xl w-full max-w-sm p-6 border border-slate-200 dark:border-slate-800 animate-scale-in">
                ...
                <input
                    ...
                    placeholder="Nome do Módulo (ex: Módulo 01)"
                    className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-lg text-sm focus:border-brand-blue outline-none mb-4 font-medium"
                />
