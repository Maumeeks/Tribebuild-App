        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {plans.map((plan, index) => {
            ...
            return (
              <div
                key={plan.name}
                // ✅ ADICIONADO: 'flex flex-col' para permitir o alinhamento
              ...
              >
                ...
                {/* ✅ ADICIONADO: 'flex-grow' ou 'flex-1' para empurrar o botão para o rodapé */}
                ...
                {/* O botão agora ficará sempre no final do card */}
